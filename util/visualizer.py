...
def save_images(webpage, visuals, image_path, dataset, aspect_ratio=1.0, width=256):
...
def save_images_single(webpage, visuals, image_path, dataset, aspect_ratio=1.0, width=256):
    """Save images to the disk.
