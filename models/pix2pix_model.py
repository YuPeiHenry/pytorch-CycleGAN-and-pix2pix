...
class Pix2PixModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.netG = networks.define_G(opt.input_nc, opt.output_nc, opt.ngf, opt.netG, opt.norm,
                                      not opt.no_dropout, opt.init_type, opt.init_gain, self.gpu_ids, progressive=opt.progressive, progressive_stages=opt.progressive_stages, downsample_mode=opt.downsample_mode, upsample_mode=opt.upsample_mode)
