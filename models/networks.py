...
class FeatureExtractor(nn.Module):
    def __init__(self, input_nc):
        ...
        self.conv2 = nn.Sequential(nn.ReplicationPad2d((0, 1, 0, 1)), nn.Conv2d(1, 12, kernel_size=2, stride=1, padding=0, bias=False), nn.InstanceNorm2d(12))
        self.conv3 = nn.Sequential(nn.Conv2d(1, 8, kernel_size=3, stride=1, padding=1, bias=False), nn.InstanceNorm2d(8))
        self.conv5 = nn.Sequential(nn.Conv2d(1, 4, kernel_size=3, stride=1, padding=1, bias=False), nn.InstanceNorm2d(4))
        self.feat_transform = nn.Sequential(nn.Conv2d(24, 1, kernel_size=1, stride=1, padding=0, bias=False), nn.InstanceNorm2d(24))
