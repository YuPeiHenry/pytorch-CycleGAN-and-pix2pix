...
class FixedUnet(nn.Module):
    ...
    def forward(self, x):
        ...
        upsample_1 = self.maxpool(concat_7)
        ...
        upsample_2 = self.maxpool(concat_9)
        ...
        upsample_3 = self.maxpool(concat_11)
        ...
        upsample_4 = self.maxpool(concat_13)
        ...
        upsample_5 = self.maxpool(concat_15)
        ...
        upsample_6 = self.maxpool(concat_17)
