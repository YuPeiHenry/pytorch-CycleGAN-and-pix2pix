...
class EmbeddingModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['G', 'A_i', 'B_i', 'A_e', 'B_e']
        # specify the images you want to save/display. The training/test scripts will call <BaseModel.get_current_visuals>
        self.visual_names = ['fake_A_i', 'fake_B_i', 'fake_A_e', 'fake_B_e']
    ...
    def backward_G(self):
        ...
        (self.loss_A_e + self.loss_A_i + self.loss_B_e + self.loss_B_i).backward()
        self.optimizer_G.step()

    def optimize_parameters(self):
        self.backward_D()
        self.backward_G()
        self.loss_G = self.loss_A_e + self.loss_B_e + self.loss_A_i + self.loss_B_i
